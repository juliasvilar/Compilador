...
tokens = (
    ...
    'PALAVRA_RES', 'BIBLIOTECA', 'OPERADOR', 'SIMBOLO_ESP', 'VOID', 'IF', 
    'ELSE', 'WHILE', 'FOR', 'RETURN', 'PRINTF', 'PLUS', 'MINUS', 'TIMES', 
    'DIVIDE', 'MOD', 'ASSIGN', 'ADD_ASSIGN', 'SUB_ASSIGN', 'MUL_ASSIGN', 
    'DIV_ASSIGN', 'MOD_ASSIGN', 'GE', 'LE', 'GT', 'LT', 'EQ', 'NE', 'LPAREN', 
